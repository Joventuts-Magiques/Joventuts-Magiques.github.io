...
age_range: "13+"
excerpt: "Formato multijugador social de Magic con mazos de 100 cartas únicas liderados por un comandante legendario."
...
- Eres el último jugador que queda con puntos de vida
- Todos los demás jugadores han sido eliminados
- Consigues una condición de victoria alternativa de una carta

Un jugador pierde cuando:
- Sus puntos de vida llegan a 0 o menos
- Ha recibido 21 o más puntos de daño de combate de un único comandante
- No puede robar una carta cuando debe hacerlo
- Una carta dice que pierde la partida

## Estrategia del Formato

### Construcción de Mazo

- **Sinergia con el comandante**: Elige cartas que potencien las habilidades de tu comandante
- **Curva de maná**: Incluye cartas de diferentes costes para mantenerte activo cada turno
- **Ramp**: Añade cartas que aceleren tu producción de maná
- **Robo de cartas**: Fundamental para mantener recursos en partidas largas
- **Remoción**: Incluye respuestas para amenazas variadas
- **Wipes**: Efectos que limpian el campo de batalla cuando te quedas atrás

### Durante la Partida

- **Política**: Commander es un juego social - las alianzas y negociaciones son clave
- **Gestión de amenazas**: No te conviertas en el jugador más peligroso demasiado pronto
- **Protección del comandante**: Protege tu comandante de remoción para evitar pagar el impuesto
- **Timing**: Observa cuándo los otros jugadores gastan sus recursos
- **Paciencia**: Las partidas son largas - no te precipites

## Mazos de Joventuts Màgiques

A continuación encontrarás los mazos de Commander que tenemos disponibles en la entidad. Estos mazos están pensados para diferentes niveles de experiencia y estilos de juego:
...
**Próximamente:**
- Mazo 1: [Nombre y descripción]
- Mazo 2: [Nombre y descripción]
- Mazo 3: [Nombre y descripción]
- Mazo 4: [Nombre y descripción]
...
3. Cada mazo incluye una guía básica de estrategia
4. Perfectos para aprender el formato o probar nuevos estilos de juego

## Consejos para Principiantes

1. **Comienza con un precon**: Los mazos preconstruidos oficiales son excelentes para aprender
2. **Elige un comandante simple**: Evita estrategias demasiado complejas al principio
3. **Comunícate**: Commander es un formato social - habla con los otros jugadores
4. **No optimices demasiado pronto**: Mazos demasiado potentes pueden no ser divertidos en mesas casuales
5. **Aprende de cada partida**: Commander tiene mucha profundidad estratégica

## Recursos

- **[EDHRec.com](https://edhrec.com/)**: Recomendaciones de cartas para cada comandante
- **[Commander Rules Committee](https://mtgcommander.net/)**: Reglas oficiales y banlist
- **[Moxfield](https://www.moxfield.com/)**: Constructor de mazos en línea
- **[Scryfall](https://scryfall.com/)**: Búsqueda de cartas con filtros avanzados
