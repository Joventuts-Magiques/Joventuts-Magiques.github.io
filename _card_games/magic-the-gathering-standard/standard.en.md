...
difficulty: "Medium"
age_range: "13+"
excerpt: "Rotating competitive Magic format with the most recent cards and dynamic metagame."
...
1. **Build your deck**: Minimum 60 cards with maximum 4 copies of each card
2. **Prepare your sideboard**: 15 cards to adjust between games (optional but recommended in tournaments)
3. **Shuffle your deck**: Make sure cards are well shuffled
4. **Life points**: Each player starts with 20 life points
5. **Starting hand**: Draw 7 cards
6. **Mulligan**: If you don't like your hand, you can mulligan (shuffle and draw 7, then put 1 on the bottom of your deck)
7. **Determine who goes first**: Die roll or coin flip
...
- **[MTGGoldfish](https://www.mtggoldfish.com/metagame/standard)**: Meta statistics and decklists
- **[MTGTop8](https://www.mtgtop8.com/format?f=ST)**: Tournament results
- **[Untapped.gg](https://mtga.untapped.gg/)**: Magic Arena statistics
